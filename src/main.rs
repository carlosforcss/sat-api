...
#[openapi(
    ...
    paths(
        ...
        routes::invoice_payment::list_payments,
        routes::invoice_payment::get_payment,
    ...
    components(schemas(
        ...
        routes::credential::CredentialPage,
        routes::crawl::CrawlResponse,
        routes::crawl::CrawlPage,
        ...
        routes::invoice::PaymentListResponse,
        routes::invoice::PaymentPage,
        routes::invoice::PaymentRelatedDocumentResponse,
        routes::invoice::PaymentDocumentTaxResponse,
